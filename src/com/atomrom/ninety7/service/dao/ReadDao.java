...
public class ReadDao {
	private static final Logger logger = Logger.getLogger(ReadDao.class.getName());

	private static final String ENTITY_KIND = "Read";
	...
	public static boolean isRead(User user, String url) {
		DatastoreService datastore = DatastoreServiceFactory.getDatastoreService();
