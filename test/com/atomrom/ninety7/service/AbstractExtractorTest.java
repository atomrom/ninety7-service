...
public class AbstractExtractorTest {
	...
	public static void main(String[] args) throws IOException {
		...
		TextAnalyzer ta = new TextAnalyzer("http://friss-hirek.hu/friss-hirek/ezzel-a-keppel-kivan-boldog-karacsonyt-orban-viktor");
		ta.extractAbstract(TextUtil.commaSeparatedListToSet("kukucs orbán szenteste viktor", 0));
		System.out.println(ta.getFullAbstractHashCode());
		System.out.println(ta.getText().hashCode());
